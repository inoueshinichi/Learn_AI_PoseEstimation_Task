...
def download_ms_coco_image_2014(dataset_dir: str):
    pass

def download_ms_coco_image_2015(dataset_dir: str):
    pass

def download_ms_coco_image_2017(dataset_dir: str): 
    type_list: list[str] = ['train2017'] # ['train2017', 'val2017', 'test2017']
...
if __name__ == "__main__":
    ...
    download_ms_coco_image_2017(dataset_dir)
